...
class CartItems extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    //           (1 - cart.productData['discountedPercentage'] / 100))
    //       .toStringAsFixed(2),
    // );

    final price = num.tryParse(cart.productData['price'].toString()) ?? 0;
    final discount =
        (num.tryParse(cart.productData['discountedPercentage'].toString()) ??
            0) /
        100;
    final finalPrice = num.parse((price * (1 - discount)).toStringAsFixed(2));
